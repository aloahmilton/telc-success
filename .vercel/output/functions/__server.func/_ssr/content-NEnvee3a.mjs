//#region node_modules/.nitro/vite/services/ssr/assets/content-NEnvee3a.js
var routes = {
	home: "/",
...
var home = {
	de: {
		...
		heroText: "Unser Ziel ist es, Menschen eine bessere Zukunft zu ermöglichen und Ihnen als verlässlicher Partner auf Ihrem Bildungsweg zur Seite zu stehen – offen, fair, flexibel.",
		pillars: [
			{
		...
		valuesText: "Wir sind uns unserer Verantwortung gegenüber unseren Kooperationspartnern und der Gesellschaft bewusst und handeln entsprechend. Qualität steht für uns an erster Stelle, sei es bei unseren Prüfungen, Produkten oder Services. Wir arbeiten eng mit unseren Partnern zusammen, um ihnen bestmögliche Lösungen zu bieten und gemeinsam zu wachsen. Diese Werte prägen unser tägliches Handeln und sind der Grundstein für unsere gute und nachhaltige Entwicklung.",
		stats: [
			{
				prefix: "über",
				value: "3.000",
				label: "telc Prüfungszentren weltweit"
			},
			{
				prefix: "über",
				value: "25.000",
				label: "telc Prüferinnen und Prüfer"
			},
			{
				prefix: "über",
				value: "100",
				label: "Prüfungsformate"
			},
			{
				prefix: "über",
				value: "1.500",
				label: "Prüfungsteilnehmende am Tag"
			}
		],
		networkTitle: "Global vernetzt",
		networkText: "telc pflegt ein weltweit wachsendes Partnernetzwerk. Gemeinsam mit unseren Partnerinstitutionen wirken wir dem Arbeits- und Fachkräftemangel entgegen und leisten einen wichtigen Beitrag zur beruflichen und gesellschaftlichen Integration von Migrantinnen und Migranten.",
		serviceCards: [
			{
				title: "Kontakt",
	...
	en: {
		...
		heroText: "We help people build a better future and stand beside them as a dependable partner along their learning path – open, fair and flexible.",
		pillars: [
			{
		...
		valuesText: "We take responsibility towards our partners and society. Quality comes first – in our exams, products and services. Together with our partners we build solutions that last.",
		stats: [
			{
				prefix: "over",
				value: "3,000",
				label: "exam centres worldwide"
			},
			{
				prefix: "over",
				value: "25,000",
				label: "trained examiners"
			},
			{
				prefix: "over",
				value: "100",
		...
		networkText: "Telc-success maintains a growing worldwide partner network. Together we counter the skills shortage and contribute to professional and social integration.",
		serviceCards: [
			{
				title: "Contact",
				text: "Get help quickly through our contact form.",
				to: routes.contact
			},
			{
				title: "Careers",
		...
		quote: "Our mission is to help people acquire, improve and prove language skills so they can reach their personal and professional goals.",
		quoteBy: "Telc-success management"
	},
	es: {
		heroTitle: "El futuro habla Telc-success",
		heroText: "Nuestro objetivo es abrir un futuro mejor a las personas y acompañarlas como socio fiable en su camino formativo: abiertos, justos y flexibles.",
		pillars: [
			{
		...
		valuesText: "Asumimos nuestra responsabilidad con los socios y con la sociedad. La calidad es lo primero: en los exámenes, los productos y los servicios. Junto a nuestros socios creamos soluciones duraderas.",
		stats: [
			{
				prefix: "más de",
				value: "3.000",
				label: "centros de examen"
			},
			{
				prefix: "más de",
				value: "25.000",
			...
			},
			{
				prefix: "más de",
				value: "100",
				label: "formatos de examen"
			},
			{
				prefix: "más de",
				value: "1.500",
				label: "candidatos al día"
			}
		],
		networkTitle: "Conectados globalmente",
		networkText: "Telc-success cuenta con una red de socios en crecimiento en todo el mundo. Juntos combatimos la falta de personal cualificado y contribuimos a la integración laboral y social.",
		serviceCards: [
			{
				title: "Contacto",
		...
		quote: "Nuestra misión es ayudar a las personas a adquirir, mejorar y demostrar competencias lingüísticas para alcanzar sus metas personales y profesionales.",
		quoteBy: "Dirección de Telc-success"
	},
	tr: {
		heroTitle: "Gelecek Telc-success konuşuyor",
		heroText: "Amacımız insanlara daha iyi bir gelecek sunmak ve eğitim yolculuklarında güvenilir bir ortak olmak – açık, adil ve esnek.",
		pillars: [
			{
				title: "Dil sınavları",
		...
		valuesText: "Ortaklarımıza ve topluma karşı sorumluluk üstleniyoruz. Sınavlarımızda, ürünlerimizde ve hizmetlerimizde kalite her zaman önce gelir. Ortaklarımızla kalıcı çözümler geliştiriyoruz.",
		stats: [
			{
				prefix: "3.000+",
				value: "3.000",
				label: "dünya genelinde sınav merkezi"
			},
			{
				prefix: "25.000+",
				value: "25.000",
				label: "eğitimli sınav görevlisi"
			},
			{
				prefix: "100+",
				value: "100",
			...
			},
			{
				prefix: "1.500+",
				value: "1.500",
				label: "günlük katılımcı"
			}
		],
		networkTitle: "Küresel ağ",
		networkText: "Telc-success dünya çapında büyüyen bir ortak ağına sahiptir. Birlikte nitelikli iş gücü açığına karşı çalışıyor, mesleki ve toplumsal uyuma katkı sunuyoruz.",
		serviceCards: [
			{
				title: "İletişim",
				text: "İletişim formumuz üzerinden hızlıca destek alın.",
				to: routes.contact
			},
			{
				title: "Kariyer",
		...
		quote: "Misyonumuz, insanların dil becerilerini kazanmasına, geliştirmesine ve belgelemesine yardımcı olmaktır.",
...
var footer = {
	...
	tr: {
		...
		addressLines: [
			"Telc-success gGmbH",
			"Bahnhofstrasse 7",
			"61352 Bad Homburg, Almanya"
		]
	}
};
var candidateSupport = {
	de: {
		...
		intro: "Wir haben uns darauf spezialisiert, Kandidatinnen und Kandidaten umfassend beim Erwerb und Nachweis ihrer Deutschkenntnisse zu unterstützen.",
		services: [
			{
	...
	en: {
		...
		intro: "We specialize in providing comprehensive support for candidates pursuing German language proficiency and certification.",
		services: [
			{
	...
	es: {
		...
		intro: "Nos especializamos en brindar un apoyo integral a los candidatos en su camino hacia la certificación de alemán B2.",
		services: [
			{
...
//#endregion
export { nav as a, ui as c, metaNav as i, footer as n, news as o, home as r, routes as s, candidateSupport as t };
